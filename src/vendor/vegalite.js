...
util.getbins = function(stats, maxbins) {
  //hack
  var b = typeof vg !== 'undefined' ? vg.bins : getbins;
  return b({
    min: stats.min,
    max: stats.max,
    maxbins: maxbins
