...
function fromSerializable(serializable) {
    ...
    // Persistent
    bookmark = serializable.bookmark, config = serializable.config, log = serializable.log, shelfPreview = serializable.shelfPreview, 
    // Then the rest should be UndoableStateBaseWithoutDataset
    undoableStateBaseWithoutDataset = __rest(serializable, ["dataset", "tableschema", "bookmark", "config", "log", "shelfPreview"]);
    var persistent = { bookmark: bookmark, config: config, shelfPreview: shelfPreview, log: log };
