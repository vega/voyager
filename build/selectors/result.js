...
exports.selectMainSpec = reselect_1.createSelector(shelf_1.selectIsQuerySpecific, shelf_1.selectIsQueryEmpty, shelf_1.selectFilters, selectResultPlots.main, function (isQuerySpecific, isQueryEmpty, filters, mainPlots) {
    if (!isQuerySpecific || !mainPlots || isQueryEmpty) {
        return undefined;
    }
    return __assign({ transform: spec_1.getTransforms(filters) }, mainPlots[0].spec);
});
...
exports.selectPlotList = result_1.RESULT_TYPES.reduce(function (selectors, resultType) {
    selectors[resultType] = reselect_1.createSelector(shelf_1.selectIsQuerySpecific, shelf_1.selectFilters, selectResultPlots[resultType], function (isQuerySpecific, filters, plots) {
        if (
