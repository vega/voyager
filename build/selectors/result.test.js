...
var plots = result_1.fromSpecQueryModelGroup(group, data).map(function (p) { return p.plot; });
var stateSpecific = {
    ...
    undoable: __assign({}, index_1.DEFAULT_STATE.undoable, { present: __assign({}, index_1.DEFAULT_STATE.undoable.present, { dataset: __assign({}, dataset_1.DEFAULT_DATASET, { data: data }), shelf: __assign({}, index_2.DEFAULT_SHELF, { spec: {
                ...
                } }), result: __assign({}, result_2.DEFAULT_RESULT_INDEX, { main: __assign({}, result_2.DEFAULT_RESULT, { plots: plots }) }) }) })
};
var stateWildcard = {
    persistent: index_1.DEFAULT_PERSISTENT_STATE,
...
describe('selectors/result', function () {
    describe('selectMainSpec', function () {
        ...
        it('should return a main spec', function () {
            expect(result_3.selectMainSpec(stateSpecific)).toEqual(__assign({ data: data, transform: spec_1.getTransforms(filters) }, plots[0].spec));
        });
    });
    describe('selectMainPlotList', function () {
        it('should return undefined', function () {
            expect(result_3.selectPlotList.main(index_1.DEFAULT_STATE)).toBe(undefined);
        });
        it('should return a main plot list', function () {
            expect(result_3.selectPlotList.main(stateWildcard)).toEqual(plots.map(function (p) { return (__assign({}, p, { transform: spec_1.getTransforms(filters) })); }));
        });
    });
});
