...
var stateSpecific = {
    ...
    undoable: __assign({}, index_1.DEFAULT_STATE.undoable, { present: __assign({}, index_1.DEFAULT_STATE.undoable.present, { dataset: __assign({}, dataset_1.DEFAULT_DATASET, { data: data }), shelf: __assign({}, index_2.DEFAULT_SHELF, { spec: spec }), result: __assign({}, result_2.DEFAULT_RESULT_INDEX, { main: __assign({}, result_2.DEFAULT_RESULT, { plots: plots }) }) }) })
};
