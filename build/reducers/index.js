...
var undoableReducerBase = reset_2.makeResetReducer(function (state, action) {
    if (state === void 0) { state = index_1.DEFAULT_UNDOABLE_STATE_BASE; }
    return {
        ...
        result: result_1.resultIndexReducer(state.result, action)
    };
}, undoableStateToReset, index_1.DEFAULT_UNDOABLE_STATE_BASE);
/**
...
var persistentReducer = reset_2.makeResetReducer(redux_1.combineReducers({
    bookmark: bookmark_1.bookmarkReducer,
    shelfPreview: shelf_preview_1.shelfPreviewReducer
}), persistentStateToReset, index_1.DEFAULT_PERSISTENT_STATE);
/**
...
exports.USER_ACTIONS = [
    ...
    actions_2.SHELF_PREVIEW_SPEC_DISABLE
];
