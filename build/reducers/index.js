...
var combinedUndoableReducer = redux_1.combineReducers({
    ...
    result: result_2.resultIndexReducer
});
var undoableReducerBase = reset_2.makeResetReducer(function (state, action) {
    ...
    switch (action.type) {
        ...
        case actions_2.SPEC_FIELD_AUTO_ADD:
            return __assign({}, state, { shelf: __assign({}, state.shelf, { spec: spec_2.shelfSpecFieldAutoAddReducer(state.shelf.spec, action, state.dataset.schema) }) });
    }
