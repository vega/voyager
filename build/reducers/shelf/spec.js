...
function shelfSpecReducer(shelfSpec, action, schema) {
    if (shelfSpec === void 0) { shelfSpec = spec_3.DEFAULT_SHELF_UNIT_SPEC; }
    return [shelfSpecReducerBase, filter_1.filterReducer].reduce(function (spec, reducer) {
        return reducer(spec, action, schema);
    }, shelfSpec);
}
exports.shelfSpecReducer = shelfSpecReducer;
function shelfSpecReducerBase(shelfSpec, action, schema) {
    if (shelfSpec === void 0) { shelfSpec = spec_3.DEFAULT_SHELF_UNIT_SPEC; }
    switch (action.type) {
        case shelf_1.SPEC_CLEAR:
            return spec_3.DEFAULT_SHELF_UNIT_SPEC;
        ...
        case shelf_1.SPEC_FIELD_AUTO_ADD: {
            ...
            if (shelfSpec.anyEncodings.length > 0 || wildcard_1.isWildcard(fieldDef.field)) {
                ...
                return __assign({}, spec_3.fromSpecQuery(topSpecQuery, shelfSpec.config), (wildcard_1.isWildcard(shelfSpec.mark) ? { mark: shelfSpec.mark } : {}));
            }
        }
        ...
        case spec_2.SPEC_FIELD_PROP_CHANGE: {
        ...
        case spec_2.SPEC_FIELD_NESTED_PROP_CHANGE: {
        ...
        case shelf_1.SPEC_LOAD:
            var _k = action.payload, spec = _k.spec, keepWildcardMark = _k.keepWildcardMark;
            ...
            return spec_3.fromSpecQuery(specQ, shelfSpec.config);
    }
    return shelfSpec;
}
