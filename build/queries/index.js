...
function relatedViewResultRequest(queryCreator, query) {
    return result_1.resultRequest(queryCreator.type, queryCreator.createQuery(query));
}
function getFeaturesForRelatedViewRules(spec) {
    ...
    spec.encodings.forEach(function (encQ) {
        ...
        else if (util_1.contains(channel_1.NONSPATIAL_SCALE_CHANNELS, encQ.channel)) {
