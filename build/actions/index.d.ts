 ...
 */
export declare type Action = (ApplicationStateAction | BookmarkAction | ConfigAction | CustomWildcardAction | DatasetAction | LogAction | RelatedViewsAction | ResetAction | ResultAction | ShelfAction | ShelfPreviewAction | UndoableAction);
