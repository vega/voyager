...
describe('reducers/shelf/filter', function () {
    ...
    describe(filter_1.FILTER_CLEAR, function () {
        it('should clear all filters', function () {
            var spec = filter_2.filterReducer(simpleSpec, {
                type: filter_1.FILTER_CLEAR
            }, schema);
    ...
    describe(filter_1.FILTER_MODIFY_EXTENT, function () {
    ...
    describe(filter_1.FILTER_MODIFY_TIME_UNIT, function () {
        it('should add a time unit to the range filter', function () {
            var spec = filter_2.filterReducer(simpleSpec, {
                type: filter_1.FILTER_MODIFY_TIME_UNIT,
                payload: {
                    index: 0,
    ...
    it('should add a time unit to the one of filter', function () {
        ...
        expect(spec.filters).toEqual([
            rangeFilter, { field: 'q2', oneOf: [1, 2, 3, 4, 5, 6, 7], timeUnit: timeunit_1.TimeUnit.DAY }
        ]);
    });
});
