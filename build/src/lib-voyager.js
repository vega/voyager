...
var Voyager = (function () {
     ...
     * @memberof Voyager
     */
    Voyager.prototype.setSpec = function (spec) {
        this.data = undefined;
    ...
    Voyager.prototype.render = function (data, config, spec) {
        var store = this.store;
        var root = this.container;
        ReactDOM.render(React.createElement(react_redux_1.Provider, { store: store },
            React.createElement(app_1.App, { dispatch: store.dispatch, data: data, config: config, spec: spec })), root);
    };
