...
var dataset_selector_1 = require("./dataset-selector");
...
var DataPanelBase = (function (_super) {
    ...
    DataPanelBase.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "pane", styleName: "data-pane" },
            ...
            showDataSourceSelector ? React.createElement(dataset_selector_1.DatasetSelector, { name: name, handleAction: handleAction }) : undefined,
