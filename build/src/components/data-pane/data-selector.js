...
var DataSelectorBase = (function (_super) {
    ...
    function DataSelectorBase(props) {
        ...
        _this.state = { modalIsOpen: false, dataText: '', dataName: '' };
    ...
    DataSelectorBase.prototype.render = function () {
        return (React.createElement("div", { styleName: 'data-selector' },
            this.props.name,
            " ",
            React.createElement("button", { onClick: this.openModal }, "Change"),
            React.createElement(react_modal_1.default, { isOpen: this.state.modalIsOpen, onRequestClose: this.closeModal, contentLabel: "Data Selector", styleName: "modal" },
                React.createElement("div", { styleName: 'modal-header' },
    ...
    DataSelectorBase.prototype.renderDataset = function (dataset) {
        var selected = (dataset.name === this.props.name) ? styles['element-selected'] : null;
    ...
    DataSelectorBase.prototype.onFileChange = function (event) {
        ...
        reader.onload = function (lEvent) {
            ...
            var values = vega.read(lEvent.target.result, { type: format });
    ...
    DataSelectorBase.prototype.onDataTextSubmit = function () {
        ...
        var format = 'csv';
        var values = vega.read(this.state.dataText, { type: format });
        this.props.handleAction(actions_1.datasetLoad(name, { values: values, format: format }));
    };
