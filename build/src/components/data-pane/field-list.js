...
var FieldListBase = (function (_super) {
    ...
    FieldListBase.prototype.renderField = function (fieldDef, popupComponent) {
        return (React.createElement(field_1.Field, { fieldDef: fieldDef, isPill: true, draggable: true, parentId: { type: constants_1.FieldParentType.FIELD_LIST }, onDoubleClick: this.onAdd, onAdd: this.onAdd, popupComponent: popupComponent }));
    };
