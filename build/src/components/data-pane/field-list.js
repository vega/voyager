...
var FieldListBase = (function (_super) {
    ...
    FieldListBase.prototype.renderField = function (fieldDef, popupComponent) {
        var _a = this.props, schema = _a.schema, handleAction = _a.handleAction;
        return (React.createElement(field_1.Field, { fieldDef: fieldDef, isPill: true, draggable: true, filterHide: wildcard_1.isWildcard(fieldDef.field), parentId: { type: constants_1.FieldParentType.FIELD_LIST }, popupComponent: popupComponent, onDoubleClick: this.onAdd, onAdd: this.onAdd, schema: schema, handleAction: handleAction }));
    };
