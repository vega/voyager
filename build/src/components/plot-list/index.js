...
var PlotListBase = (function (_super) {
    ...
    PlotListBase.prototype.render = function () {
        var _a = this.props, plots = _a.plots, handleAction = _a.handleAction, bookmark = _a.bookmark;
        var plotListItems = plots.map(function (plot) {
            var spec = plot.spec, fieldInfos = plot.fieldInfos;
            return (React.createElement(plot_1.Plot, { key: JSON.stringify(spec), fieldInfos: fieldInfos, handleAction: handleAction, isPlotListItem: true, scrollOnHover: true, showBookmarkButton: true, showSpecifyButton: true, spec: spec, bookmark: bookmark }));
        });
