...
var EncodingShelfBase = (function (_super) {
    ...
    EncodingShelfBase.prototype.field = function () {
        ...
        return (React.createElement("div", { styleName: 'field-wrapper' },
            React.createElement(index_1.Field, { draggable: true, fieldDef: fieldDef, filterHide: true, isPill: true, popupComponent: functionPicker, onRemove: this.onRemove.bind(this), parentId: { type: constants_1.FieldParentType.ENCODING_SHELF, id: id } })));
    };
