...
var EncodingShelfBase = (function (_super) {
    ...
    EncodingShelfBase.prototype.field = function () {
        ...
        var functionPicker = renderFunctionPicker ?
            React.createElement(function_picker_1.FunctionPicker, { fieldDef: fieldDef, onFunctionChange: this.onFunctionChange.bind(this) }) : null;
        return (React.createElement("div", { styleName: 'field-wrapper' },
            React.createElement(index_1.Field, { draggable: true, fieldDef: fieldDef, popupComponent: functionPicker, onRemove: this.onRemove.bind(this), isPill: true, parentId: { type: constants_1.FieldParentType.ENCODING_SHELF, id: id } })));
    };
