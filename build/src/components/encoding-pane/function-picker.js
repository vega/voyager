...
var FunctionPickerBase = (function (_super) {
    ...
    FunctionPickerBase.prototype.render = function () {
        var _this = this;
        var fieldDefParts = this.props.fieldDefParts;
        var fn = fieldDefParts.aggregate || fieldDefParts.timeUnit || (fieldDefParts.bin && 'bin') || undefined;
        var supportedFns = getSupportedFunction(fieldDefParts.type);
        var radios = supportedFns.map(function (f) {
            return React.createElement("label", { styleName: "func-label", key: f || '-' },
