...
var ViewPaneBase = (function (_super) {
    ...
    ViewPaneBase.prototype.render = function () {
        var _a = this.props, data = _a.data, handleAction = _a.handleAction, query = _a.query, mainResult = _a.mainResult;
        ...
        if (isSpecific) {
            ...
            return (React.createElement("div", { className: "pane", styleName: "view-pane-gallery" },
                ...
                React.createElement(plot_list_1.PlotList, { handleAction: handleAction, plots: plots })));
        }
    };
    return ViewPaneBase;
}(React.PureComponent));
