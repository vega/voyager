...
exports.ViewPane = react_redux_1.connect(function (state) {
    return {
        data: selectors_1.selectData(state),
        query: selectors_1.selectQuery(state),
        filters: selectors_1.selectFilters(state),
        // FIXME: refactor the flow for this part (we should support asynchrounous request for this too)
        mainResult: selectors_1.selectMainResult(state),
