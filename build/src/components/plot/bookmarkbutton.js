...
var BookmarkButtonBase = (function (_super) {
    ...
    BookmarkButtonBase.prototype.render = function () {
        var bookmarkColor = (this.isBookmarked()) ? '#0c96d0' : '#aaa';
        return (React.createElement(TetherComponent, { attachment: "top right", targetAttachment: "bottom left" },
            React.createElement("i", { className: "fa fa-bookmark command-bookmark", style: { color: bookmarkColor, paddingLeft: '3px' }, onClick: this.onBookmarkClick }),
    ...
    BookmarkButtonBase.prototype.isBookmarked = function () {
        var _a = this.props, bookmark = _a.bookmark, plotObject = _a.plotObject;
