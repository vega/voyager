...
var filter_2 = require("../../reducers/shelf/filter");
...
var FieldBase = (function (_super) {
    ...
    FieldBase.prototype.getFilter = function () {
        ...
        var domain = schema.domain(fieldDef);
    ...
    FieldBase.prototype.addFilterSpan = function () {
        return !this.props.filterHide && (React.createElement("span", null,
...
var fieldSource = {
    beginDrag: function (props) {
        ...
        var filter = filter_2.getFilter(fieldDef, schema.domain(fieldDef));
