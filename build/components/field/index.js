...
var FieldBase = (function (_super) {
    ...
    FieldBase.prototype.filterAddToEnd = function () {
        var _a = this.props, filterShow = _a.filterShow, fieldDef = _a.fieldDef, schema = _a.schema;
        var domain;
        ...
        if (filter_1.containsFilter(filterShow.filters, filter)) {
    ...
    FieldBase.prototype.getFilter = function () {
        ...
        return filter_1.getFilter(fieldDef, domain);
    };
