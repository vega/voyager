...
var FieldBase = (function (_super) {
    ...
    FieldBase.prototype.render = function () {
        ...
        var fn = fieldDef.fn, field = fieldDef.field, title = fieldDef.title;
        ...
        var component = (React.createElement("span", { styleName: isWildcardField ? 'wildcard-field-pill' : isPill ? 'field-pill' : 'field', onDoubleClick: this.onDoubleClick },
            this.caretTypeSpan(),
            this.funcSpan(fn),
            React.createElement("span", { styleName: isFieldFn ? 'fn-text' : 'text' }, title || (field !== '*' ? field : '')),
            this.addFilterSpan(),
            this.addSpan(),
            this.removeSpan()));
    ...
    FieldBase.prototype.filterAddToIndex = function (index) {
    ...
    FieldBase.prototype.filterAddToEnd = function () {
        var handleAction = this.props.handleAction;
        handleAction({
            type: filter_1.FILTER_ADD,
            payload: {
    ...
    FieldBase.prototype.filterRemove = function (index) {
        var handleAction = this.props.handleAction;
        handleAction({
    ...
    FieldBase.prototype.getFilter = function () {
        var _a = this.props, fieldDef = _a.fieldDef, schema = _a.schema;
        if (wildcard_1.isWildcard(fieldDef.field)) {
            return;
        }
        var domain = schema.domain({ field: fieldDef.field });
        return filter_2.getFilter(fieldDef, domain);
    };
    ...
    FieldBase.prototype.addFilterSpan = function () {
        return this.props.filterShow && (React.createElement("span", null,
            React.createElement("a", { onClick: this.filterAddToEnd.bind(this) },
                React.createElement("i", { className: 'fa fa-filter' }))));
    };
    FieldBase.prototype.funcSpan = function (fnName) {
...
var fieldSource = {
    beginDrag: function (props) {
        ...
        var filter = filter_2.getFilter(fieldDef, domain);
