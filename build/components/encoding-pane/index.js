...
var EncodingPanelBase = (function (_super) {
    ...
    EncodingPanelBase.prototype.render = function () {
        ...
        var wildcardShelvesGroup = !manualSpecificationOnly && (React.createElement("div", { styleName: "shelf-group" },
...
exports.EncodingPane = react_redux_1.connect(function (state) {
    ...
    return {
        spec: selectors_1.selectShelf(state).spec,
        filters: selectors_1.selectShelf(state).spec.filters,
