...
var BookmarkBase = (function (_super) {
    ...
    BookmarkBase.prototype.onExport = function () {
        ...
        for (var _i = 0, _a = bookmark.list; _i < _a.length; _i++) {
            ...
            specs.push(__assign({}, bookmarkItem.plotObject.spec, { description: bookmarkItem.note }));
        }
    ...
    BookmarkBase.prototype.renderBookmarks = function (bookmark) {
        ...
        var bookmarkPlotListItems = plots.map(function (plot) {
            ...
            return (React.createElement(plot_1.Plot, { bookmark: _this.props.bookmark, closeModal: _this.closeModal.bind(_this), key: specKey, fieldInfos: fieldInfos, handleAction: _this.props.handleAction, isPlotListItem: true, showBookmarkButton: true, showSpecifyButton: true, spec: spec }));
        });
