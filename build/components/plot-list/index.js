...
var PlotListBase = (function (_super) {
    ...
    PlotListBase.prototype.render = function () {
        ...
        var plotListItems = plots.map(function (plot) {
            ...
            return (React.createElement(plot_1.Plot, { key: JSON.stringify(spec), fieldInfos: fieldInfos, handleAction: handleAction, isPlotListItem: true, showBookmarkButton: true, showSpecifyButton: true, spec: spec, bookmark: bookmark }));
        });
