...
var ViewPaneBase = (function (_super) {
    ...
    ViewPaneBase.prototype.render = function () {
        var isQuerySpecific = this.props.isQuerySpecific;
        var manualSpecificationOnly = this.props.config.manualSpecificationOnly;
        var relatedViews = !manualSpecificationOnly && (React.createElement("div", { className: "pane", styleName: !this.props.relatedViews.isHidden ?
                "view-pane-related-views" : "view-pane-related-views-hide" },
            React.createElement(related_views_button_1.RelatedViewsButton, { relatedViews: this.props.relatedViews, handleAction: this.props.handleAction }),
        ...
        if (isQuerySpecific) {
            return (React.createElement("div", { styleName: "view-pane" },
                React.createElement("div", { className: "pane", styleName: this.props.relatedViews.isHidden ?
