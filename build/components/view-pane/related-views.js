...
var RelatedViewsBase = (function (_super) {
    ...
    RelatedViewsBase.prototype.render = function () {
        var _this = this;
        var _a = this.props, bookmark = _a.bookmark, handleAction = _a.handleAction, plotsIndex = _a.plotsIndex, results = _a.results;
        var subpanes = index_2.RELATED_VIEWS_TYPES.map(function (relatedViewType) {
            var plots = plotsIndex[relatedViewType];
            var title = index_2.RELATED_VIEWS_INDEX[relatedViewType].title;
            var limit = results[relatedViewType].limit;
            return (plots && plots.length > 0 &&
                React.createElement("div", { styleName: "related-views-subpane", key: relatedViewType },
                    ...
                    React.createElement(index_4.PlotList, { handleAction: handleAction, plots: plots, bookmark: bookmark, limit: limit, resultType: relatedViewType })));
        });
...
exports.RelatedViews = react_redux_1.connect(function (state) {
    return {
        plotsIndex: result_1.RESULT_TYPES.reduce(function (index, resultType) {
            index[resultType] = result_2.selectPlotList[resultType](state);
            return index;
        }, {}),
