...
var FieldListBase = (function (_super) {
    ...
    FieldListBase.prototype.renderField = function (fieldDef, popupComponent) {
        ...
        return (React.createElement(field_1.Field, { fieldDef: fieldDef, isPill: true, draggable: true, filterShow: !wildcard_1.isWildcard(fieldDef.field) && !(fieldDef.field === '*'), parentId: { type: constants_1.FieldParentType.FIELD_LIST }, caretShow: true, popupComponent: popupComponent, onDoubleClick: this.onAdd, onAdd: this.onAdd, schema: schema, handleAction: handleAction }));
    };
