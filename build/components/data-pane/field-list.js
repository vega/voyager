...
var FieldListBase = (function (_super) {
    ...
    FieldListBase.prototype.renderField = function (fieldDef, popupComponent) {
        var _a = this.props, schema = _a.schema, filters = _a.filters, handleAction = _a.handleAction;
        var filterShow;
        if (!wildcard_1.isWildcard(fieldDef.field) && !(fieldDef.field === '*')) {
            filterShow = { filters: filters };
        }
        return (React.createElement(field_1.Field, { fieldDef: fieldDef, isPill: true, draggable: true, filterShow: filterShow, parentId: { type: constants_1.FieldParentType.FIELD_LIST }, caretShow: true, popupComponent: popupComponent, onDoubleClick: this.onAdd, onAdd: this.onAdd, schema: schema, handleAction: handleAction }));
    };
