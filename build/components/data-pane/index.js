...
var DataPaneBase = (function (_super) {
    ...
    DataPaneBase.prototype.render = function () {
        ...
        var _a = this.props.config, showDataSourceSelector = _a.showDataSourceSelector, relatedViews = _a.relatedViews;
        ...
        var wildcardFields = relatedViews !== 'disabled' && fieldCount > 0 && (React.createElement("div", { styleName: "data-pane-section" },
