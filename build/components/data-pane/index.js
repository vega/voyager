...
var DataPanelBase = (function (_super) {
    ...
    DataPanelBase.prototype.render = function () {
        ...
        var _a = this.props.config, showDataSourceSelector = _a.showDataSourceSelector, manualSpecificationOnly = _a.manualSpecificationOnly;
        ...
        var wildcardFields = !manualSpecificationOnly && fieldCount > 0 && (React.createElement("div", { styleName: "data-pane-section" },
