...
function configureStore(initialState) {
    ...
    var store = redux_1.createStore(reducers_1.rootReducer, initialStateWithHistory, composeEnhancers(redux_1.applyMiddleware.apply(void 0, middleware), exports.actionLogs.enhancer)
